...
{
    public partial class SpendDAL : RepositoryBase<Spend>, ISpendDAL
    {
        /// <summary>
        /// 分页获取,默认按照时间降序排序
        /// </summary>
        ...
        public List<Spend> GetPage(int pageIndex, int pageSize, out int allRowsCount, object predicate = null, IList<ISort> sort = null)
        {
            ...
            {
                sort = new List<ISort>();
                sort.Add(Predicates.Sort<Spend>(p => p.ID, true));
            }
        ...
        {
            return base.Delete(Predicates.Field<Spend>(p => p.ID, Operator.Eq, primaryId));
        }
    }
}
